function twitterpage(current_page_id, query_arr, totalrecords, recordperpage, anchor) {
    if (typeof current_page_id === "undefined") { current_page_id = 1; }
    if (typeof query_arr === "undefined") { query_arr = Object(); }
    if (typeof totalrecords === "undefined") { totalrecords = 1; }
    if (typeof recordperpage === "undefined") { recordperpage = 15; }
...
exports.twitterpage = twitterpage;
function seturl(seturl) {
    this.url = seturl;
}
